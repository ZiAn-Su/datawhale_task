...
## 5神经网络
### 小结
本节介绍了神经元模型、感知机和多层网络，推导了反向传播的公式，包括计算神经元、权重、偏移的导数，并介绍两种减少过拟合的方法，接下来讲述如何跳出局部最小，寻找全局最小，还介绍了多种常用的神经网络。
### 笔记
![神经网络](./神经网络.svg)
## 6支持向量机
### 小结
首先介绍了支持向量机的基本理念，对于分类问题，找到一个超平面，可以有效地将不同类别的数据点分开，以及优化的基本形式；接着介绍如何将基本优化问题转为对偶问题，及求解方法；然后引入核函数，使得SVM可以处理非线性问题；接下来介绍软间隔支持向量机，在优化问题中加入对误分类的惩罚项；随后，讲述了支持向量回归的方法，面向回归问题；基于SVM和SVR的核函数方法，将核函数方法扩展到一般优化问题。
### 笔记
![支持向量机](./支持向量机.svg)
